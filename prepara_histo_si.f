...
*     pull e PH (per silicio e per strip)
         call hbook1(isilicio*100000,'PH',200,0.5,2000.5,0.)
         call hbook1(isilicio*100000+1,'Pull',100,0.5,400.5,0.)

*     pullL, pullR e ETA (per silicio e per strip)
         call hbook1(isilicio*100000+2,'PullL',100,0.5,400.5,0.)
         call hbook1(isilicio*100000+3,'PullR',100,0.5,400.5,0.)
*         call hbook1(isilicio*100000+4,'eta',200,-2.,2.,0.)
         call hbook1(isilicio*100000+4,'eta',50,-1.,1.,0.)

*     cluster
         call hbook1(isilicio*100000+5,'nr Strip',10,0.5,10.5,0.)
         call hbook1(isilicio*100000+6,'ampiezza',200,0.5,2000.5,0.) 
         call hbook1(isilicio*100000+7,'baricentro cluster',100,0.5,10.5
     $        ,0.)
         call hbook1(isilicio*100000+8,'SNR',100,0.5,500.5,0.)
